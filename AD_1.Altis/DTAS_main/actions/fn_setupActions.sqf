...
GVAR(actions) pushBack (player addAction ["Re-equip gear", {[true] call DFUNC(assignGear)}, [], 0, true, true, "", "roundInProgress && player getVariable ['isPlaying', false] && (currentWeapon player isEqualTo '')"]);
